    ...
    <style>
        ...
        * {
        ...
        .inp {
            ...
            outline: none;
            border-radius: 60px;
            box-shadow: -1px 1px 30px -11px rgba(243, 70, 186, 0.71);
            padding: 0 20px;
            margin: 10px 0;
        }
        .btn1 {
...
<section class="login py-5 bg-light">
    <img src="RDS/resources/images/menu.png" id="menuBtn" alt="new">
    <div class="container pt-3">
        <div class="row g-0 pt-5">
            <div class="ps-5 pt-5 mt-5 col-lg-5">
                <img width="200" height="200" src="RDS/resources/images/customers.png" class="img-fluid" alt="Customer Image">
            </div>
