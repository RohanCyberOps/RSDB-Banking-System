...
<head>
    ...
    <title>Our Services - RSDB Bank</title>
...
<div class="py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <!-- Services Grid -->
        <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3 animate__animated animate__fadeInUp">
            <?php foreach ($services as $index => $service): ?>
                <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow animate__animated animate__fadeInUp" style="animation-delay: <?php echo $index * 0.1; ?>s;">
                    <i data-lucide="<?php echo $service["icon"]; ?>" class="w-12 h-12 text-pink-500 mb-4"></i>
                    <h3 class="text-xl font-semibold mb-2"><?php echo $service["title"]; ?></h3>
                    <p class="text-gray-600"><?php echo $service["description"]; ?></p>
                    <button class="mt-4 text-pink-500 font-medium flex items-center hover:scale-105 transition-transform">
                        Learn More
                        <i data-lucide="arrow-right-circle" class="w-4 h-4 ml-2"></i>
                    </button>
                </div>
            <?php endforeach; ?>
        </div>
